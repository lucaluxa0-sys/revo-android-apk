...
# atomic continued-stroke dispatch, and desktop MoveSpeed parity stages.
for script in (
    ...
    TOOLS / 'patch-native-v0212-joystick-atomic-continuation.py',
...
print('PASS: applied v0.2.12 template/foreground, full-deflection joystick, dedicated callbacks, atomic continued strokes, and desktop MoveSpeed timing stages')
